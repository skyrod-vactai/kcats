...
#+TITLE: The kcats Programming Language Prototype Implementation
...
programmatically search for words. Here's an example of doing that [[file:book-of-kcats.org::*Search the
...
We've defined what axiom words do in clojure code but we can document
these words a bit further. We can list their specs and some examples in native kcats data format.

See [[file:lexicon.org::*Builtin words documentation][Builtin words documentation]].

Now that we have enough axiom words defined, we can define more words
as a standard library, in native kcats. It will be a list of pairs
(we'll go into more detail on this particular data type in [[*Maps/associations][Association
Lists]]). See [[file:lexicon.org::*Lexicon][Lexicon]].
...
Native documentation will go [[file:lexicon.org::*Associative words][here]].

The rest of the definitions can be added to the [[file:lexicon.org::*Associative words][lexicon]]. 

** Methods
See [[file:lexicon.org::*Methods][Methods]].
...
See [[file:lexicon.org::*Programmable Runtime][Programmable Runtime]].
** Pipes
*** Basics
...
For words in the lexicon, see here: [[file:lexicon.org::*Pipes][Pipes]]
*** Notes
