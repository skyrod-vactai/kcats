...
#+begin_src kcats
  ...
  "dd"
  ;; write a parser for splitting - takes an input and output (top)
  ;"axb" ;; input
  ;[] ;; output
  ;"bc"

  [ ;; output on top
   [👥 [📮 1️⃣] 🪄  ;; add new value to input buffer
     ;;  in delim inbuf
  ...
  ⚖️ 
  [🔀 [👥] ••🐋 ▶️] ;; exec a copy of parser program: output input input-buffer parser
