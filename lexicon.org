...
#+begin_src kcats kcats :tangle src/kcats/core/collections.kcats :mkdirp yes
  ...
  [indexof [[spec [[item list] [item]]]
            [definition [[indexer] 🪄
                         ...
                         keep generate first]]
            [examples [[[[[a b c] [take] [c] unwrap indexof] 🛡️] [2] "Get the index of first matching item"]
                       [[[[a b c] [take] [d] unwrap indexof] 🛡️] [🔳] "No matching item -> Nothing"]
                       [[[[a b c d c e] [take] [c] unwrap indexof] 🛡️] [2] "Multiple matches returns index of first match"]]]]]

  [interpose [[spec [[item ordered] [ordered]]]
              [definition [🔳 flip
                           [🔀 pair join [pop] 🛡️] step
                           🗑️ pop 🗑️]]
  ...
  [flatten [[spec [[list] [list]]]
            [definition [🔳 🔀 [list? ☯️] 🛡️ [🗑️ put] 🔳 [step ▶️] recur]]
  ...
  [[liberate [[spec [🔳 [program]]]
   ...
   [frequencies [[spec [[] [association]]]
                 [definition [🔳 association
                              ...
                              cram]]
                 [examples [[[["Hello there!" [take] frequencies] 🛡️]
                             [[[\space 1]
                               [\! 1]
                               [\H 1]
                               [\e 3]
...
#+begin_src kcats :tangle src/kcats/stdlib/database.kcats :mkdirp yes
  ...
  [[fork [[▶️] map]]
   [triangle [[🔳 [[take] 🪄 🔀 [[put] 🛡️ sink 🔀 pair] bail] collect] •🛡️]]
   [indexed-as-property [🔀 indexed
                         [unwrap sink assign] map •🗑️]]
   [join-all [[first empty] 🛡️ 🔀 [join] step]]
...
#+begin_src kcats
  [[hash 🔳]
   ...
   [rehash [[children [data] map] 🛡️ [first] 🛡️ empty 🔀 [join] step hash wrap [0] 🔀 update]]]
  [["foobarbaz" [["foobar" [["foo" 🔳]
                            ["bar" 🔳]]]
                 ["baz" 🔳]]]
   [1 1]
