...
#+begin_src kcats :tangle src/kcats/core/dictionary.kcats :mkdirp yes
  ...
  [definition [[spec [[list] [program]]]
               [definition [[entries **1 definition] pack dictionary swap lookup]]
...
#+begin_src kcats
Dict has 192 words
After loading modules Dict has 246 words
"[[0x5593b83087a0 : [131, 153, 201, 57, 106, 114, 130, 82, 30, 55, 97, 32, 36, 231, 69, 69, 84, 52, 139, 30, 250, 171, 141, 155, 78, 205, 174, 27, 156, 57, 39, 251]/plus2, DictEntry(Entry { examples: None, spec: None, definition: [Int(2), +], namespace: None })]]"
[[entries 238_entries]
 [modules []]]
[[entries 219_entries]
 [modules []]]
