...
#+begin_src kcats :tangle src/kcats/core/execute.kcats :mkdirp yes
  ...
  [🪆 [[spec [[[program combinator]
       ...
       [definition [[✂️3️⃣ [4️⃣ 3️⃣ 2️⃣ 1️⃣ 🪆 ▶️] ✂️1️⃣] [🎒]
                    ••🛡️ ▶️ ••🗑️ 🔀 ⚖️]]
       [examples [[[5
                    [2 >] 🛡️
                    [🗑️ 👥 dec] 🔳 [▶️ *]
  ...
  [💉 [[spec [program program]]
       [doc "The needle represents an injection - creates a program where it injects the given program into the list below
...
#+begin_src kcats :tangle src/kcats/core/dictionary.kcats :mkdirp yes
  ...
  [draft [[spec [[[sized definitions]] [[program dictionary-updater]]]]
          [definition [[[1] [entry] update] 🚜 ;; create full entries for each definition
                       🎁 [🔗] 🔗]]]]  ;; add 'join' to join the entries with the existing dictionary
