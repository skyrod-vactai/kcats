...
#+begin_src kcats :tangle src/kcats/builtins.kcats :mkdirp yes
  ...
  [using [[spec [[[list namespaces] program] [program]]]]]
...
#+begin_src kcats :tangle src/kcats/lexicon.kcats :mkdirp yes
  ...
  [revise [[spec [[program [list bindings]] [*]]]
           [definition [[[[1]
                          [[[definition]] swap wrap join [update] join] update]
                         map] dip inscribe]]]]

  [draft [[spec [[program [list bindings]] [*]]]
