...
#+begin_src kcats :tangle src/kcats/builtins.kcats :mkdirp yes
  ...
  [inscribe [[spec [[[sized module] [word alias]] [*]]]]]
...
#+begin_src kcats :tangle src/kcats/lexicon.kcats :mkdirp yes
  ...
  [revise [[spec [[[sized bindings] [list quoted-module-alias]] [*]]]
           [definition [[[0] [wrap [definition] join] update] map
                        [[update] join] map
                        [joiner] assemble unwrap ;encode
                        [unwrap] dip inscribe]]]]

  [draft [[spec [[[sized bindings] [list quoted-module-alias]] [*]]]
          [definition [[[1] [wrap] update] map revise]]
          [examples [[[[[swap [5]]]
                       ["a" "b" "c" swap]
                       draft]
                      ["a" "b" "c" 5]]
