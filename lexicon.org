...
#+begin_src kcats :tangle src/kcats/core/dictionary.kcats :mkdirp yes
  ...
  [use [[spec [[[list module-names]] [dictionary]]]
        [definition [dictionary swap
                     [[definition] unwrap pair [lookup] shield shielddown] step]]]]

  [using [[spec [[program [list module-names]] [*]]]
          [definition [[use] dip confine]]]]
  ...
  [inscribe [[spec [[[program module] [bytes namespace]] [dictionary]]]
