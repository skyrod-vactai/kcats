...
#+begin_src kcats :tangle src/kcats/stdlib/compare-builtins.kcats :mkdirp yes
...
#+end_src
** Stack Ops
#+begin_src kcats :tangle src/kcats/stdlib/stack-builtins.kcats :mkdirp yes
  [drop [[spec [[item] []]]
...
#+begin_src kcats :tangle src/kcats/stdlib/motion-builtins.kcats :mkdirp yes
...
#+end_src
** Program execution
#+begin_src kcats :tangle src/kcats/stdlib/execute-builtins.kcats :mkdirp yes
...
#+end_src
** Collections
#+begin_src kcats :tangle src/kcats/stdlib/collections-builtins.kcats :mkdirp yes
...
#+end_src
*** Associations
#+begin_src kcats :tangle src/kcats/stdlib/associations-builtins.kcats :mkdirp yes
...
#+end_src
** Dictionary modules
#+begin_src kcats :tangle src/kcats/stdlib/dictionary-builtins.kcats :mkdirp yes
  [dictionary [[spec [[] [list]]]]]

  [define [[spec [[association] []]]]]

  [decache [[spec [[word] [bytes]]]]]
  
  [inscribe [[spec [[[sized module] [item optional-alias]] [*]]]]]

  [dictmerge [[spec [[item] []]]]]

  [resolve [[spec [[program [list namespaces]] [*]]]]]
...
#+begin_src kcats :tangle src/kcats/stdlib/dictionary.kcats :mkdirp yes
  ...
  [entry [[spec [[[sized dict-entry]] [[association full-entry]]]]
          [definition [[1] [[definition] label wrap] update]]]]
  ...
  [let [[spec [[[program p]
                [program dictionary-modifier]] [*]]]
        [definition [[] sink [inscribe wrap] dip using] ]
        [examples [[[[[times5 [5 *]]
                      [doubledec [dec dec]]]
...
#+end_src
** Math
#+begin_src kcats :tangle src/kcats/stdlib/math-builtins.kcats :mkdirp yes
...
#+end_src
** Serialization
#+begin_src kcats :tangle src/kcats/stdlib/serialize-builtins.kcats :mkdirp yes
...
#+end_src
** Boolean logic
#+begin_src kcats :tangle src/kcats/stdlib/boolean-builtins.kcats :mkdirp yes
...
#+begin_src kcats :tangle src/kcats/stdlib/encode-builtins.kcats :mkdirp yes
...
#+end_src
** Strings
#+begin_src kcats :tangle src/kcats/stdlib/strings-builtins.kcats :mkdirp yes
  ...
  ;; Doesn't really belong here but good enough for now
...
#+end_src
** Error handling
#+begin_src kcats :tangle src/kcats/stdlib/errors-builtins.kcats :mkdirp yes
...
** Pipes
#+begin_src kcats :tangle src/kcats/stdlib/pipe-builtins.kcats :mkdirp yes
...
#+end_src
** Nested Environments
#+begin_src kcats :tangle src/kcats/stdlib/environment-builtins.kcats :mkdirp yes 
...
#+end_src
** Templating macro
#+begin_src kcats :tangle src/kcats/template.kcats :mkdirp yes
