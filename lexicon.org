...
#+begin_src kcats :tangle src/kcats/lexicon.kcats
  ...
  [generate [[spec [[program item] [program item]]]
             [definition [clone [execute] dip swap]]
             [examples [[[1 [inc clone] generate] [2 [inc clone] 2]]]]]]

  ;; TODO: This impl works but is ugly
  [assemble [[spec [[program] [list]]]
             [definition [[] ;; result
                          true ;; n
                          [[generate clone] dip ;; r n n
                           swap put ;; r n 
                           swap] ;; n r
                          loop
                          pop discard]]
             [examples [[[[[1 2 3 4] [take] assemble] shield]
                         [[1 2 3 4]]]
                        [[[0 10 1 range [take]
                           5 dropper
                           [10 *] mapper
  ...
  [mapper [[spec [[program] [program]]]
           [definition [[generate] swap
                        [bail shielddown]
                        decorate join]]
           [examples [[[[[1 2 3 4] [take]
                         [clone *] mapper
                         assemble]
                        shield]
  ...
  [taker [[spec [[] [program]]]
          [definition [[[positive?] [dec [generate] dip swap] [discard []] if]]]
          [examples [[[[[1 2 3 4 5] [take]
                        3 taker
                        assemble]
                       shield]
  ...
  [dropper [[spec [[] [program]]]
            [definition [[[[positive?]
                           ...
                           while
                           [generate swap] dip swapdown swap]
                          bail]]]
            [examples [[[[[1 2 3 4 5] [take]
                          3 dropper
                          assemble]
  ...
  [filter [[spec [[program list] [list]]]
           [definition [[] sink
                        [shield dip] decorate
                        [swap] unwrap prepend
                        [sink [put] [discard] branch] join
                        step]]
           [examples [[[[1 2 3] [odd?] filter] [[1 3]]]
                      [[[2 4 6] [odd?] filter] [[]]]
                      [[33 [1 2 3] [+ odd?] filter] [33 [2]]]
                      [[3 [1 2 3] [discard odd?] filter] [3 [1 2 3]]]]]]]
...
#+RESULTS:
: [200 [10 [0 >] [clone dec] while] environment [[expression] lookup something? [positive?] dip and] [eval-step [dec] dip] while [stack] lookup]
