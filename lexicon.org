...
#+begin_src kcats :tangle src/kcats/stdlib/assocations.kcats :mkdirp yes
  ;; Associative words
...
*** Sets
#+begin_src kcats :tangle src/kcats/stdlib/sets.kcats :mkdirp yes
...
** Pipes
#+begin_src kcats :tangle src/kcats/stdlib/pipes.builtins.kcats :mkdirp yes
...
** Time and date
#+begin_src kcats :tangle src/kcats/time.kcats :mkdirp yes
