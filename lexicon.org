...
#+begin_src kcats :tangle src/kcats/core/collections-builtins.kcats :mkdirp yes
  ...
  [remove [[spec [[item [sized container]] [[sized container]]]]
           [doc "Remove an item from a container. If there are multiple occurences, removes all of them."]
           [examples [[[[a b c] [b] 🍫 remove] [[a c]] "Remove item from a list (inefficient)"]
                      [[[a b c b d] [b] 🍫 remove] [[a c d]] "Remove item from a list that occurs more than once"]
  ...
  [slice [[spec [[[integer start] [integer end] ordered] [ordered]]]
          ...
          [examples [[["foobar" 0 3 slice] ["foo"] "Slice a string with valid indices"]
                     ...
                     [[["foobar" -4 3 slice] [🗑️ "outofbounds"] 🩹 ▶️] ["outofbounds"] "Slice a string with index before beginning -> error"]
                     [["foobarbazquux" 0 -4 slice] ["foobarbaz"] "Slice a string from start to distance from end"]
                     [["foobarbazquux" -8 0 slice] ["foobarbaz"] "Slice a string from distance from end to end"]
                     [["foobarbazquux" -8 -4 slice] ["rbaz"] "Slice a string from distance from end to distance from end"]
