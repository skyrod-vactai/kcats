...
#+begin_src kcats :tangle src/kcats/core/collections-builtins.kcats :mkdirp yes
  ...
  [first [[spec [[ordered] [item]]]
          [examples [[[[4 5 6] first] [4] "Get first item of list"]
                     [["foo" first] [\f] "Get first item of string"]
                     [[[] first] [[]] "Get first item of empty list -> Nothing"]]]]]
  ...
  [take [[spec [[dispenser] [item dispenser]]]
         [examples [[[["a" "b" "c"] take] [["b" "c"] "a"] "Take a string from a list"]
                    ...
                    [[[[a "foo"] [b "foo"] [c "foo"]] take second] ["foo"] "Take an entry from association is nondeterministic"]
                    [[[1 3 5 7 9] set take odd?] [yes] "Take item from set is nondeterministic"]]]]]
