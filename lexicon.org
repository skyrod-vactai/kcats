...
#+begin_src kcats :tangle src/kcats/builtins.kcats :mkdirp yes
  ...
  [inscribe [[spec [[[word alias] [bytes module]] [*]]]]]
...
#+begin_src kcats :tangle src/kcats/lexicon.kcats :mkdirp yes
  ...
  [revise [[spec [[[list quoted-module-alias] [sized bindings]] [*]]]
           [definition [[[[0] [wrap [definition] join] update] map
                         [[update] join] map
                         [joiner] assemble unwrap encode] dip ;; under the module name
                        unwrap inscribe]]]]

  [draft [[spec [[[list quoted-module-alias] [sized bindings]] [*]]]
          [definition [[[[1] [wrap] update] map] dip revise]]
          [examples [[[[[swap [5]]]
                       ["a" "b" "c" swap]
                       draft]
                      ["a" "b" "c" 5]]
