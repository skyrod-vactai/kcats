...
type StepFn = for<'r> fn(&'r mut Environment) -> Result<&mut Environment, String>;

fn f_stack1(f: fn(Item) -> Result<Item, String>) -> impl Fn(&mut Environment) -> Result<&mut Environment, String> {
    move |env| {
...
fn f_stack2(f: fn(Item, Item) -> Result<Item, String>) -> impl Fn(&mut Environment) -> Result<&mut Environment, String> {
    move |env| {
        let i = env.Stack.pop();
        let j = env.Stack.pop();
        match (i, j) {
