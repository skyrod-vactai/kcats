...
(defn from-spec
  ...
  [{::keys [spec] :as dfn}]
  (let [[in out] spec]
    (assoc dfn ::fn (eval `(stack-effect in out)))))
  ...
  {'execute {::spec (stack-spec :p ::program)
   ...
   'lexicon {::spec (stack-spec)
             ::fn (fn [{::keys [stack expression dictionary]}]
                    ...
                    {::stack (concat (list (-> "src/kcats/lexicon.kcats"
                                               io/file
                                               io/reader
