                 ...
                 (if (= -1 bytes-read)
                   ...
                   (let [retbuf (make-array Byte/TYPE bytes-read)]
                     (System/arrayCopy #^bytes buf 0
                                       #^bytes retbuf 0 (.length #^bytes retbuf))
                     retbuf))))
  Close
  (close [this] (.close is))
...
#+RESULTS:
: #namespace[kcats.pipe]nilclass clojure.lang.Compiler$CompilerExceptionclass clojure.lang.Compiler$CompilerExceptionSyntax error (IllegalArgumentException) compiling . at (kcats:localhost:34271(clj)*:14:22).
: No matching method arrayCopy found taking 5 args for class java.lang.System
