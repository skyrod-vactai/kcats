...
#+RESULTS:
: Stack { stack: [Number(1), Number(2), Number(3), Plus], tos: 0 }
: Stack { stack: [Number(2), Number(3), Plus, Number(1)], tos: 0 }
: Stack { stack: [Number(3), Plus, Number(1), Number(2)], tos: 0 }
: Stack { stack: [Plus, Number(1), Number(2), Number(3)], tos: 0 }
