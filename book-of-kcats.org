...
(def base-words
  {'discard {::spec (stack-spec :item ::item)
   ...
   'prepend {::spec (stack-spec :item ::item
                                :aggregate ::aggregate)
   ...
   'bytes {::spec (stack-spec :item ::item)
           ::definition '[[[[clone string?] [getbytes]]
                           [[clone bytes?] []]]
                          decide]}
   'map {::spec (stack-spec :program ::program
                            :aggregate ::aggregate)
         ;; remaining list to process
         ;; snapshot of the original stack, minus list
         ;; [] result
         ::definition '[[snapshot [] swap] ;; save original stack, and
                                           ;; add an empty list to
                                           ;; hold results
                        dipdown ;; do this underneath the program and aggregate
