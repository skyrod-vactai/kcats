...
#+begin_src kcats 
  ["examples/books.kcats" file-out slurp read [take] 3 taker collect] shield ;; pi
  [] ;; po
  timestamps
  "Alice"
  [[swap take dropdown pair [a b] swap zip] dip join]
...
#+RESULTS:
#+begin_src kcats
[generate [[["Alice" [[values [[type integer]
                               [units milliseconds]]]
                      [from systemtime]
                      [type out]]
             [] [[[author-first "George"]
            ...
            swap [unwrap] dip [swap take dropdown pair [a b]
                               swap zip]
            dip join]
           bail]
 shielddown]
...
#+begin_src kcats
[1 2 3 4] [take] [inc] each generate
#+end_src
