              ...
              Item::Word(w) => {
                  ...
                  if w_str == "▶️" {
                      ...
                      if let Some(Op::Push(Item::List(l))) = ops.last() {
                          let l_clone = l.clone();
                          ops.pop();
                          let inner_chunk = compile(&l_clone);
                      ...
                      if len >= 2 {
                          if let (Op::Push(Item::List(f)), Op::Push(Item::List(t))) = (&ops[len-1], &ops[len-2]) {
                              ...
                              let mut true_chunk = compile(&t_clone);
                              true_chunk.ops.pop();
                              ...
                              let mut false_chunk = compile(&f_clone);
                              false_chunk.ops.pop();
