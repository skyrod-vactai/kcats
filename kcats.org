...
#+begin_src rust :tangle src/main.rs :mkdirp yes
  ...
  use kcats::types::container::{error, pipe::Out, List};
  ...
  async fn main() {
      ...
      println!("Size of Error: {}", mem::size_of::<error::Error>());
      println!("Size of Word: {}", mem::size_of::<types::Word>());
      println!("Size of Out (pipe): {}", mem::size_of::<Out>());
...
#+begin_src rust :tangle src/types/container/pipe/channel.rs :mkdirp yes
  ...
  pub fn sender(i: Item) -> axiom::ItemResult {
      ...
      h.close_take();
      Ok(Item::In(pipe::In::Handoff(Box::new(h))))
  }
  ...
  pub fn receiver(i: Item) -> axiom::ItemResult {
      let mut h = Handoff::try_derive(i).map_err(Error::derive)?;
      h.close_put();
      Ok(Item::Out(pipe::Out::Handoff(Box::new(h))))
  }
  ...
  impl Derive<Timer> for Item {
      fn derive(t: Timer) -> Self {
          Item::Out(pipe::Out::Timer(Box::new(t)))
      }
  }
