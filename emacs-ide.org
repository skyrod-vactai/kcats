...
#+BEGIN_SRC emacs-lisp :results none
  ...
  (defconst kcats-font-lock-keywords
        `(("\\[\\|\\]" 0 'kcats-brackets)
          ...
          (,(regexp-opt '("swap" "swapdown" "swapdeep" "drop" "dropdown" "dropdeep" "sink" "float" "clone" "snapshot" "evert" "flip") 'words) . (0 font-lock-builtin-face))
          (,(regexp-opt '("yes" "[]") 'words) . (0 font-lock-constant-face))
          ...
          (,(regexp-opt '("execute" "dip" "dive" "divedown" "divedeep" "dipdown" "dipdeep" "shield" "shielddown" "shielddeep" "inject"
                          "loop" "while" "until" "prime" "if" "when" "branch" "recur" "times" "let") 'words) . '(0 font-lock-preprocessor-face))
